        ...
        @if($item->children->count() > 0)
            ...
            >
                ...
                <div 
                    ...
                    class="absolute sub-menu left-0 top-full mt-1 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-50 sm:block flex flex-col"
                    style="display: none;"
                >
                    <div class="py-1">
