...
<div class="error-page px-4 sm:px-6 lg:px-8">
    <div class="max-w-lg mx-auto text-center">
        <h1 class="text-xl font-bold text-primary">{{ __('errors.404.code') }}</h1>
        ...
        <div class="mt-4">
            ...
            <div class="mt-8 bottom-actions">
                <a href="/" class="group back-button button inline-flex items-center px-4 py-2 text-base font-medium text-white bg-primary hover:shadow-md rounded-lg transition-all duration-150">
